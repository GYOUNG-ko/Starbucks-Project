	...
	<div class = "container">
		...
		<div id="verificationModal" class="modal">
	   		<div class="modal-content" align="center">
		        <input type="text" class="input_box" id="name" placeholder="이름을 입력하세요"><br>
		        <input type="text" class="input_box" id="userId" placeholder="아이디를 입력하세요"><br>  
		        <input type="text" class="input_box" id="phone" placeholder="전화번호 입력하세요">
