...
<script type="text/javascript" async="" src="https://www.googletagmanager.com/gtag/js?id=G-WC8Q3C59QP&amp;cx=c&amp;_slc=1"></script>
<script src="https://connect.facebook.net/ko_KR/sdk.js?hash=96eabc6cb3ed78376bcdffa8bb74c134" async="" crossorigin="anonymous"></script>
...
<script async="" type="text/javascript" src="/common/js/esabsbuxkr.js?async" id="c33fb2186c94ef9f1b467a8b5d6bdca1"></script>
<!-- 220117 수정 -->
...
.ms_user_info.ms_user_add .ms_user_starbg {
    background: url("https://www.starbucks.co.kr/common/img/util/ms_myreward_star_bg.png");
			...
			<header class="ms_sub_tit_wrap">
				<div class="ms_sub_tit_bg">
					<div class="ms_sub_tit_inner">
						<h4>
							<img alt="My 음료/매장" src="https://www.starbucks.co.kr/common/img/util/ms_ttl.png">
						</h4>
						<ul class="smap">
							<li><a href="/"><img
					...
					<div class="regular_user_index" style="display: none;">
						...
						<section class="regu_user_info regu_info_add">
							...
							<article class="regu_user_info_center">
								<p>
									<strong class="userName">${sessionScope.nickName}</strong> 님 안녕하세요.<br>
						...
						<section class="ms_user_info ms_user_add">
							...
							<article class="ms_user_info_left">
								...
								<p class="ms_user_stat mo_block">
									<span><strong class="userName">${sessionScope.name}<!-- 홍길동 --></strong>
										님은</span><br> <span>현재 <strong
										class="en userGrade t_bd9b60">${sessionScope.grade}</strong>이십니다.
									</span>
								</p>
								<!-- 20200805 PLCC 추가 -->
								...
								<p class="ms_user_stat_notice">
									<strong class="en t_bd9b60">${sessionScope.grade}</strong>을 유지 중 입니다.<br>무료음료
									쿠폰 발행까지 12개의 별이 남았습니다.
								</p>
							</article>
							<article class="ms_user_info_right">
								<p class="ms_user_stat">
									<span><strong class="userName">${sessionScope.name}</strong>
										님은</span> <span>현재 <strong class="en userGrade t_bd9b60">${sessionScope.grade}</strong>이십니다.
									</span>
								</p>
								<!-- 20200805 PLCC 추가 -->
								<div class="plcc-logo" style="display: none;">
				...
				<nav class="ms_nav" id="msRnb">
					<ul>
						...
						<li><a href="javascript:void(0);">개인정보관리<span
							...
							<ul>
								<li><a href="javascript:void(0);" required="login"
									data-href="/myinfo_modify">· 개인정보확인 및 수정</a></li>
								<li><a href="javascript:void(0);" required="login"
									data-href="/myinfo_delete">· 회원 탈퇴</a></li>
								<li><a href="javascript:void(0);" required="login"
