...
public class MemberService {
	...
	public String registProc(MemberDTO member) {
		...
		/*
			암호문 : $2a$10$gXXb94t6ZcIp5LzojBJ1z.GQpz1S376iO8w0fjyg9s6NbaXMJ.1zm
			암호문 길이 : 60
			
			암호문 : $2a$10$05iK5J13Bh23UHFe/gIeP.wjKkhhliuHnZDop1R.XxuYFBM0YhJMS
			암호문 길이 : 60
			
			pw 컬럼의 크기를 암호문 크기와 같거나 크게 변경 (60보다 크게)
